...
class _ComponentCaptureScreenState extends State<ComponentCaptureScreen> {
  ...
  void initState() {
    ...
    if (existing != null) {
      ...
      try {
        _resolvedEntry = context.read<HierarchyRepository>().entryByIndex(
          existing.hierarchyIndex,
        );
      } catch (_) {
        _resolvedEntry = null;
      }
      ...
      builder: (context) => DraggableScrollableSheet(
        ...
        builder: (context, scrollController) => Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'This item has more than one database entry - pick the matching one:',
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                        'SFG ${e.sfgCode} · RSL ${e.rsl} · Rate ${e.rate}',
                      ),
            ...
            child: Column(
              children: [
                ...
                _levelTile(
                  ...
                  enabled: _group != null,
                  onTap: () =>
                      _pick(1, 'Select System', hierarchy.systems(_group!)),
                ),
                _levelTile(
                  step: 3,
                  label: 'Element',
                  ...
                  onTap: () => _pick(
                    2,
                    'Select Element',
                    hierarchy.elements(_group!, _system!),
                  ),
                ),
                _levelTile(
                  step: 4,
                  ...
                  onTap: () => _pick(
                    3,
                    'Select Sub-Element',
                    hierarchy.subElements(_group!, _system!, _element!),
                  ),
                ),
                _levelTile(
                  step: 5,
